 ...
 * Client Component - handles carousel state, smooth scroll, and lead form modal.
 */
        ...
        <>
            ...
            >
                ...
                {heroSlides.map((slide, index) => (
                    <div
                        key={slide}
                        className={`absolute inset-0 overflow-hidden sm:rounded-b-xl transition-opacity duration-1000 ${index === currentSlide ? "opacity-100" : "opacity-0"
                            }`}
                    >
                        <Image
                            src={slide}
